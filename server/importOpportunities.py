...
class importOpportunities():
    """ Imports volunteering opportunities from the Volunteer Match api (https://www.volunteermatch.org/) and
        ...
        To use:
            Configure the self.query object with the parameters you wish to use, then execute the script via
            execfile("importOpportunities.py")
    ...
    def __init__(self, username, secret, ongoing=False):
        ...
        self.query = {
            ...
            "radius": "35",
            "categoryIds": [23, 22, 14, 42, 15, 11, 7, 39, 41, 17, 12],
            "sortCriteria": "eventdate",
            "fieldsToDisplay": ["title", "plaintextDescription", "parentOrg", "postalCode", "vmUrl"],
        }
        if ongoing:
